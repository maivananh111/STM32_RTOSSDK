 ...
 * @param resS
 */
void LOG_RES(result_t res){
	LOG_RET("RESULT", "Return %s, time = %d[%s -> %s -> %d]", Result_Str[res.Status], res.Line);
}

/**
 * @fn void LOG_MEMORY(void)
 * @brief
 *
 * @pre
 * @post
...
void LOG_MEMORY(void){
	memory_info_t mem = sys_get_memory_info();
