...
#define CONFIG_RTOS_APP_MAIN_TASK_SIZE              stackdepth_kilobyte(4U)
...
#define stackdepth_byte(x)                      		(x/4)
#define stackdepth_kilobyte(x)                       ((x*1024U)/4U)
...
#define CONFIG_LOG_UART_BAUDRATE                    1152000U
