...
result_t tim::register_event_handler(void(*function_ptr)(tim_channel_t channel, tim_event_t event, void *param), void *param){
	result_t ret;
...
result_t tim::unregister_event_handler(void){
	result_t ret;
...
result_t tim::start(void){
	result_t ret;

	if(_tim -> CR1 & TIM_CR1_CEN){
		set_return(&ret, E_BUSY, __LINE__);
#if CONFIG_USE_LOG_MONITOR && TIM_LOG
...
#if ENABLE_DMA
result_t tim::start_dma(uint32_t *count_buf, uint16_t size){
	result_t ret;
...
result_t tim::set_mode_pwm_output(tim_channel_t channel, tim_pwm_t *conf){
	result_t ret;
	...
	if(_tim == TIM1 || _tim == TIM2) 										func = AF1_TIM1_2;
		...
		set_return(&ret, E_NOTAVAILABLE, __LINE__);
		return ret;
	}
...
result_t tim::pwm_output_start(tim_channel_t channel, uint32_t pwm){
	result_t ret;
...
result_t tim::pwm_output_stop(tim_channel_t channel){
	result_t ret;
...
result_t tim::pwm_output_start_it(tim_channel_t channel, uint32_t pwm){
	result_t ret;
...
result_t tim::pwm_output_stop_it(tim_channel_t channel){
	result_t ret;
	if(_conf -> interrupt == TIM_INTERRUPT_DISABLE){
		set_return(&ret, E_FAIL, __LINE__);
#if CONFIG_USE_LOG_MONITOR && TIM_LOG
...
#if ENABLE_DMA
result_t tim::pwm_output_start_dma(tim_channel_t channel, uint32_t *pwm_buffer, uint16_t size){
	result_t ret;
	dma_t dma = NULL;
...
result_t tim::pwm_output_stop_dma(tim_channel_t channel){
	result_t ret;
	dma_t dma = NULL;
...
result_t tim::pwm_output_set_duty(tim_channel_t channel, uint32_t pwm){
	result_t ret;
...
result_t tim::set_mode_pwm_input(tim_channel_t channel, tim_pwm_t *conf){
	result_t ret;
...
result_t tim::pwm_input_start(tim_channel_t channel){
	return inputcapture_start(channel);
}

result_t tim::pwm_input_stop(tim_channel_t channel){
	return inputcapture_stop(channel);
}

result_t tim::pwm_input_start_it(tim_channel_t channel){
	return inputcapture_start_it(channel);
}

result_t tim::pwm_input_stop_it(tim_channel_t channel){
	return inputcapture_stop_it(channel);
}
#if ENABLE_DMA
result_t tim::pwm_input_start_dma(tim_channel_t channel, uint32_t *pwm_buffer, uint16_t size){
	return inputcapture_start_dma(channel, pwm_buffer, size);
}

result_t tim::pwm_input_stop_dma(tim_channel_t channel){
...
/* TIMER ENCODER MODE */
result_t tim::set_mode_encoder(tim_encoder_t *conf){
	result_t ret;
...
result_t tim::encoder_start(void){
	result_t ret;
...
result_t tim::encoder_stop(void){
	result_t ret;
...
result_t tim::encoder_start_it(void){
	result_t ret;
...
result_t tim::encoder_stop_it(void){
	result_t ret;
...
#if ENABLE_DMA
result_t tim::encoder_start_dma(uint32_t *encA_buffer, uint32_t *encB_buffer, uint16_t size){
	result_t ret;
...
result_t tim::encoder_stop_dma(void){
	result_t ret;
...
result_t tim::set_mode_inputcapture(tim_channel_t channel, tim_inputcapture_t *conf){
	result_t ret;
...
result_t tim::inputcapture_start(tim_channel_t channel){
	result_t ret;
...
result_t tim::inputcapture_stop(tim_channel_t channel){
	result_t ret;
...
result_t tim::inputcapture_start_it(tim_channel_t channel){
	result_t ret;
...
result_t tim::inputcapture_stop_it(tim_channel_t channel){
	result_t ret;
...
#if ENABLE_DMA
result_t tim::inputcapture_start_dma(tim_channel_t channel, uint32_t *capture_buffer, uint16_t size){
	result_t ret;
	dma_t dma = NULL;
...
result_t tim::inputcapture_stop_dma(tim_channel_t channel){
	result_t ret;
	dma_t dma = NULL;
...
result_t tim::set_mode_outputcompare(tim_channel_t channel, tim_outputcompare_t *conf){
	result_t ret;
...
result_t tim::outputcompare_start(tim_channel_t channel, uint32_t value){
	return pwm_output_start(channel, value);
}

result_t tim::outputcompare_stop(tim_channel_t channel){
	return pwm_output_stop(channel);
}

result_t tim::outputcompare_start_it(tim_channel_t channel, uint32_t value){
	return pwm_output_start_it(channel, value);
}

result_t tim::outputcompare_stop_it(tim_channel_t channel){
	return pwm_output_stop_it(channel);
}

#if ENABLE_DMA
result_t tim::outputcompare_start_dma(tim_channel_t channel, uint32_t *oc_buffer, uint16_t size){
	return pwm_output_start_dma(channel, oc_buffer, size);
}

result_t tim::outputcompare_stop_dma(tim_channel_t channel){
	return pwm_output_stop_dma(channel);
}
#endif


result_t tim::set_pulse(tim_channel_t channel, uint32_t pulse){
	result_t ret;
